...
type TbuttonsProp = { isLogin: boolean, buttonActions: ({title}: { title: string }) => void }
...
function ButtonChild({isLogin, buttonActions}: TbuttonsProp) {
...
export default function Buttons(buttonsProp: TbuttonsProp) {
    return <ButtonChild {...{...buttonsProp}} />
}
